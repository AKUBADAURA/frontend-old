...
const POASeguimientoCasosDocumentos = (props) => {
                        ...
                        {documentos.map((documento) => (
                            <TableRow key={documento.id}>
                                ...
                                <TableCell align="right">
                                    <a href={url + '/poas/' + documento.poaId} target="_blank" rel="noopener noreferrer">
                                        <Button>{documento.poaId}</Button>
                                    </a>
                                </TableCell>
...
export default POASeguimientoCasosDocumentos