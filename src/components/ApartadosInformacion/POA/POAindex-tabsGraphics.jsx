...
const POAindexTabsGraphics = (props) => {
  const options = {
    scales: {
      yAxes: [
        {
  ...
  return (
    <>
      <div className="p-0 m-0 itemTabsGraphics">
        <div className='header'>
          <h5 className='titleBar headerTabsGraphics'>Sectores Económicos</h5>
        </div>
        <Doughnut className="bodyTabsGraphics" data={dataSector} options={optionsSectores} />
      </div>
      <br />
      <div className="p-0 m-0 itemTabsGraphics">
        <div className='header'>
          <h5 className='titleBar headerTabsGraphics'>Tipos de comunidad</h5>
        </div>
      ...
      <div className="p-0 m-0 itemTabsGraphics">
        <div className='header'>
          <h5 className='titleBar headerTabsGraphics'>Estado</h5>
        </div>
        <Pie className="bodyTabsGraphics" data={dataEstado} options={optionsEstado} />
      </div>
      <br />
      <div className="p-0 m-0 itemTabsGraphics">
        <div className='header'>
          <h5 className='titleBar headerTabsGraphics'>Etapa</h5>
        </div>
        <Doughnut className="bodyTabsGraphics" data={dataEtapa} options={optionsEtapa} />
      </div>
    </>
...
export default POAindexTabsGraphics;