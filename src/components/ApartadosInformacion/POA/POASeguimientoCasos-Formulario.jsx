...
const POASeguimientoCasosFormulario = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.edit === true) {
            loadSeguimientoCasos() //carga datos en los campos para su edición
    ...
    //functions
    const settingSeguimientoCaso = () => {
        const { seguimientoCaso } = props

        console.log('seguimientoCaso INICIAL: ', seguimientoCaso)

        setNewSeguimientoCasos({
            ownerId: seguimientoCaso.ownerId,
            poaId: seguimientoCaso.poaId
        })


        setNewSeguimientoCasos1({
            s1nombreProyecto: seguimientoCaso.s1nombreProyecto,
            s1reglonEconomico: seguimientoCaso.s1reglonEconomico,
            s1responsable: seguimientoCaso.s1responsable,
            s1operador: seguimientoCaso.s1operador,
            s1financiador: seguimientoCaso.s1financiador
        })
        setNewSeguimientoCasos2({
            s2nombreComunidad: seguimientoCaso.s2nombreComunidad,
            s2pueblo: seguimientoCaso.s2pueblo,
            s2numeroHabitantes: seguimientoCaso.s2numeroHabitantes,
            s2ubicacionGeografica: seguimientoCaso.s2ubicacionGeografica,
            s2reconocimiento: seguimientoCaso.s2reconocimiento,
            s2desplazamiento: seguimientoCaso.s2desplazamiento,
            s2riesgoExtincion: seguimientoCaso.s2riesgoExtincion,
            s2fragilidadDemografica: seguimientoCaso.s2fragilidadDemografica
        })

        setNewSeguimientoCasos2b({
            s2territorio: seguimientoCaso.s2territorio,
            s2areaProtegida: seguimientoCaso.s2areaProtegida,
            s2areaReservaforestal: seguimientoCaso.s2areaReservaforestal,
            s2areaBaldios: seguimientoCaso.s2areaBaldios
        })

        setNewSeguimientoCasos3({
            s3procesoConsulta: seguimientoCaso.s3procesoConsulta,
            s3estadoConsulta: seguimientoCaso.s3estadoConsulta,
            s3consultaConcertada: seguimientoCaso.s3consultaConcertada,
            s3porqueConsultaConcertada: seguimientoCaso.s3porqueConsultaConcertada
        })
        setNewSeguimientoCasos4({
            s4participantesComunidad: seguimientoCaso.s4participantesComunidad,
            s4participantesEntesControl: seguimientoCaso.s4participantesEntesControl,
            s4participantesGobierno: seguimientoCaso.s4participantesGobierno,
            s4participantesOrganizaciones: seguimientoCaso.s4participantesOrganizaciones
        })

        setNewSeguimientoCasos5({
            s5documentosPrevioConsulta: seguimientoCaso.s5documentosPrevioConsulta,
            s5fuentesFinanciacion: seguimientoCaso.s5fuentesFinanciacion,
        })
        setNewSeguimientoCasos6({
            s6garantiaEquipoTecnico: seguimientoCaso.s6garantiaEquipoTecnico,
            s6financiacionLogistica: seguimientoCaso.s6financiacionLogistica,
        })
        setNewSeguimientoCasos7({
            s7claridadInformacion: seguimientoCaso.s7claridadInformacion,
            s7preguntasComunidad: seguimientoCaso.s7preguntasComunidad,
            s7exposicionalcances: seguimientoCaso.s7exposicionalcances,
        })
        setNewSeguimientoCasos8({
            s8estudioImpactoAmbiental: seguimientoCaso.s8estudioImpactoAmbiental,
            s8concertadoEstudio: seguimientoCaso.s8concertadoEstudio,
            s8plasmaConcertado: seguimientoCaso.s8plasmaConcertado,

        })
        setNewSeguimientoCasos9({
            s9planManejoAmbiental: seguimientoCaso.s9planManejoAmbiental,
            s9concertadoPlan: seguimientoCaso.s9concertadoPlan,
            s9plasmaConcertado: seguimientoCaso.s9plasmaConcertado,
        })
        setNewSeguimientoCasos10({
            s10planCompensacion: seguimientoCaso.s10planCompensacion,
            s10concertadoCompensacion: seguimientoCaso.s10concertadoCompensacion,
            s10plasmaConcertado: seguimientoCaso.s10plasmaConcertado,
        })
        setNewSeguimientoCasos11({
            s11consultaConcertada: seguimientoCaso.s11consultaConcertada,
            s11relacionPlanVida: seguimientoCaso.s11relacionPlanVida,
            s11relacionPlanSalvaguarda: seguimientoCaso.s11relacionPlanSalvaguarda,
            s11relacionProtocolosBioculturales: seguimientoCaso.s11relacionProtocolosBioculturales,
            s11relacionProtocolosCP: seguimientoCaso.s11relacionProtocolosCP,
        })
        setNewSeguimientoCasos12({
            s12cumplimientoAcuerdos: seguimientoCaso.s12cumplimientoAcuerdos,
            s12observaciones: seguimientoCaso.s12observaciones,
        })
        setNewSeguimientoCasos13({
            s13comiteSeguimientoAcuerdos: seguimientoCaso.s13comiteSeguimientoAcuerdos,
            s13comiteReunido: seguimientoCaso.s13comiteReunido,
            s13integrantesComite: seguimientoCaso.s13integrantesComite,
            s13garantesIndigenas: seguimientoCaso.s13garantesIndigenas,
            s13garantesGobierno: seguimientoCaso.s13garantesGobierno,

        })
        setNewSeguimientoCasos14({
            s14monitoreoAmbiental: seguimientoCaso.s14monitoreoAmbiental,
            s14PeriodicidadMonitoreo: seguimientoCaso.s14PeriodicidadMonitoreo,
            s14participantesMonitoreo: seguimientoCaso.s14participantesMonitoreo,
            s14participacionComunidad: seguimientoCaso.s14participacionComunidad,
        })
        setNewSeguimientoCasos15({
            s15tipoAfectaciones: seguimientoCaso.s15tipoAfectaciones
        })
        setNewSeguimientoCasos16({
            s16tipoBeneficios: seguimientoCaso.s16tipoBeneficios
        })
        setNewSeguimientoCasos17({
            s17conflictosGenerados: seguimientoCaso.s17conflictosGenerados
        })
        setNewSeguimientoCasos18({
            s18defensaTerritorial: seguimientoCaso.s18defensaTerritorial
        })
        setNewSeguimientoCasos19({
            s19anexo1: seguimientoCaso.s19anexo1,
            s19tipoAnexo1: seguimientoCaso.s19tipoAnexo1,
            s19anexo2: seguimientoCaso.s19anexo2,
            s19tipoAnexo2: seguimientoCaso.s19tipoAnexo2,
            s19comentarios: seguimientoCaso.s19comentarios,
        })

    }

    const loadSeguimientoCasos = async () => {
        await settingSeguimientoCaso()
    }
    ...
    const saveEditSeguimientoCasos = async (e) => {
        e.preventDefault();
        setShow(false)
        try {
            /*    
            if (selectedFile1) {
                const formData1 = new FormData(selectedFile1.target.form);
                await axios.post(`${url}/files`, formData1)
            }
            if (selectedFile2) {
                const formData2 = new FormData(selectedFile2.target.form);
                await axios.post(`${url}/files`, formData2)
            }
            setNewSeguimientoCasos2(
                {...newSeguimientoCasos2, 
                    's2territorio': dataletS2territorio,
                    's2areaProtegida':dataletS2areaProtegida,
                    's2areaReservaforestal':dataletS2areaReservaforestal,
                    's2areaBaldios':dataletS2areaBaldios
                }
                ) */
            ...
            console.log('Seguimiento Caso Final: ', newSeguimientoCasosTotal)
            await axios.patch(`${url}/seguimiento-casos/${props.seguimientoCaso.id}`, newSeguimientoCasosTotal, config)


            ///almacenamiento de registro de nuevos datos en DB archivo público

            // if (newSeguimientoCasos19.s19anexo1.length > 0) {
            //     await axios.post(`${url}/archivo-publico`,
            //         {
            //             name: POA.nombrePOA,
            //             route: newSeguimientoCasos19.s19anexo1,
            //             type: newSeguimientoCasos19.s19tipoAnexo1 ? newSeguimientoCasos19.s19tipoAnexo1 : 'Otro',
            //             origin: POA.id.toString()
            //         },
            //         config)

            // }
            // console.log('anexo2 : ', (newSeguimientoCasos19.s19tipoAnexo2 === ("Sentencia" || "Comunicados" || "Auto de Seguimiento" || "Actas" || "Documentos Relacionados al POA" || "Otro")))
            // console.log('anexo2 second condition: ', newSeguimientoCasos19.s19anexo2.length > 0)
            // if (newSeguimientoCasos19.s19anexo2.length > 0) {
            //     await axios.post(`${url}/archivo-publico`,
            //         {
            //             name: POA.nombrePOA,
            //             route: newSeguimientoCasos19.s19anexo2,
            //             type: newSeguimientoCasos19.s19tipoAnexo2 ? newSeguimientoCasos19.s19tipoAnexo2 : 'Otro',
            //             origin: POA.id.toString()
            //         },
            //         config)
            ...
            alert('Seguimiento al Caso editado con éxito')
    ...
    const saveNewSeguimientoCasos = async (e) => {
        ...
        try {
            ...
            await axios.post(`${url}/seguimiento-casos`, newSeguimientoCasosTotal, config)
            ///almacenamiento de registro de nuevos datos en DB archivo público
            if (newSeguimientoCasos19.s19anexo1.length > 0) {
                await axios.post(`${url}/archivo-publico`,
                    {
    ...
    const settingFile1 = (e) => {

        //let nameFile1 = e.target.files[0].name 
        setNewSeguimientoCasos19({
            ...newSeguimientoCasos19,
            's19anexo1': `${url}/files/${e.target.files[0].name}`
        })
        setSelectedFile1(e) //almacena file en state de manera temporal
    }

    const settingFile2 = (e) => {

        //let nameFile1 = e.target.files[0].name 
        setNewSeguimientoCasos19({
            ...newSeguimientoCasos19,
            's19anexo2': `${url}/files/${e.target.files[0].name}`
        })
        setSelectedFile2(e) //almacena file en state de manera temporal
    }
    ...
    return (
        <>
            ...
            <div className="col-12 d-flex justify-content-between mt-2 align-items-center">
                ...
                {
                    props.edit === true
                        ? (<><h3 className="m-0">Edición de registro</h3><Button variant="contained" color="primary" size="small" onClick={(e) => saveNewSeguimientoCasos(e)} startIcon={<SaveIcon />}>Guardar</Button></>)
                        : <><h3 className="m-0">Nuevo registro</h3><Button variant="contained" color="primary" size="small" onClick={(e) => saveEditSeguimientoCasos(e)} startIcon={<SaveIcon />}>Guardar Cambios</Button></>
                }
            </div>
            <hr className="d-flex justify-content-between align-items-center divisor"></hr>
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel1'} onChange={handleChangeAccordion('panel1')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel2'} onChange={handleChangeAccordion('panel2')}>
            ...
            <div className="col-12 w-100 containerMapSeguimientoCasos mb-5 px-1">
              ...
              />  
                    ...
                    <RadioButtonsGroup
                        label="¿En riesgo de extinción?"
                        name="s2riesgoExtincion"
                        options={optionsBinary}
                        value={newSeguimientoCasos2.s2riesgoExtincion}
                        handleChange={handleChangeNewSeguimientoCasos2} />
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel3'} onChange={handleChangeAccordion('panel3')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel4'} onChange={handleChangeAccordion('panel4')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel5'} onChange={handleChangeAccordion('panel5')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel6'} onChange={handleChangeAccordion('panel6')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel7'} onChange={handleChangeAccordion('panel7')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel8'} onChange={handleChangeAccordion('panel8')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel9'} onChange={handleChangeAccordion('panel9')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel10'} onChange={handleChangeAccordion('panel10')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel11'} onChange={handleChangeAccordion('panel11')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel12'} onChange={handleChangeAccordion('panel12')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel13'} onChange={handleChangeAccordion('panel13')}>
            ...
            <Accordion className="w-100" square expanded={expandedCasos === 'panel14'} onChange={handleChangeAccordion('panel14')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel15'} onChange={handleChangeAccordion('panel15')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel16'} onChange={handleChangeAccordion('panel16')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel17'} onChange={handleChangeAccordion('panel17')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel18'} onChange={handleChangeAccordion('panel18')}>
            ...
            {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Accordion className="w-100" square expanded={expandedCasos === 'panel19'} onChange={handleChangeAccordion('panel19')}>
                ...
                <AccordionDetails className="row">
                    <RadioButtonsGroup label="¿Tipo de anexo 1?" name="s19tipoAnexo1" options={optionsTipoAnexo} value={newSeguimientoCasos19.s19tipoAnexo1} handleChange={handleChangeNewSeguimientoCasos19} />
                    <form className="my-3 px-1 " >
                        <label htmlFor="files1">Selecciona el anexo 1: </label>
                        <br />
                        <input
                            id="files"
                            name="files"
                            type="file"
                            onChange={settingFile1}
                        />
                    </form>
                    <RadioButtonsGroup label="¿Tipo de anexo 2?" name="s19tipoAnexo2" options={optionsTipoAnexo} value={newSeguimientoCasos19.s19tipoAnexo2} handleChange={handleChangeNewSeguimientoCasos19} />
                    <form className="my-3 px-1 ">
                        <label htmlFor="files2">Selecciona el anexo 2: </label>
                        <br />
                        <input
                            id="files2"
                            name="files2"
                            type="file"
                            onChange={settingFile2}
                        />
                    </form>
...
export default POASeguimientoCasosFormulario
