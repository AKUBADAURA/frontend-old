...
const ReporteGraficas = () => {
    ...
    const { POASYCasosReporte } = useContext(POAContext)
    ...
    return (
        <div className='row d-flex justify-content-between'>
            <div className="col-6 d-flex justify-content-between flex-column mt-2">
                <div className='header'>
                    <h5 className='titleBar'>Etapa:</h5>
                </div>
                <Doughnut data={dataEtapa} options={optionsEtapa} />
            </div>
            <div className="col-5 d-flex justify-content-between flex-column mt-2">
                <div className='header'>
                    <h5 className='titleBar'>Tipos de comunidad:</h5>
                </div>
                <Bar data={dataTipoComunidad} options={options} />
            </div>
            <div className="col-5 d-flex justify-content-between flex-column mt-2">
                <div className='header'>
                    <h5 className='titleBar'>Sectores Económicos:</h5>
                </div>
                <Doughnut
                    data={dataSector}
            ...
            <div className="col-5 d-flex justify-content-between flex-column mt-2">
                <div className='header'>
                    <h5 className='titleBar'>Estado:</h5>
                </div>
