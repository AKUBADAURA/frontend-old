...
const Somos = () => {
    ...
    //functions 
    const getSomos= async ()=> {
        try {
            const response = await axios.get(`${url}/nosotros/somos`)
            setSomos(response.data)
        }
        catch (error) {
